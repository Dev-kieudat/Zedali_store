                    ...
                    <?php foreach ($products as $value): ?>
                        <tr>
                            ...
                            <td style="width: 130px; background-color: #f8f8f8; padding: 10px; text-align: left; border: 1px solid #ccc;">
                                ...
                                <a href="index.php?API=delete_product&id=<?= $value['id'] ?>" onclick="return confirm('Bạn có chắc chắn muốn xóa sản phẩm này không?')"><input style="margin-left: 5px; width: 35px; height: 25px;" type="button" value="Xóa"></a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                </tbody>
