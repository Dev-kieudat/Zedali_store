<footer>
    <div class="footer-infomation">
        <div class="address">
            <div class="footer-logo"><img src="images/logo.png" alt="company logo"></div>
            <div class="foot-address">
                <div class="foot-address-bold">
                    <H4>CÔNG TY CỔ PHẦN THỜI TRANG VIỆT NAM</H4>
                    <H4>Hotline: 1900 2005</H4>
        ...
        <div class="about">
            <h4>GIỚI THIỆU Zeldalis</h4>
            <p><a href="index.php?API=about">Giới thiệu</a></p>
            <p><a href="#">Blog</a></p>
            <p><a href="#">Hệ thống cửa hàng</a></p>
            <p><a href="index.php?API=feedback">liên hệ với Zeldalis</a></p>
        </div>
    ...
    <div class="footer-conect-link">
        ...
        <div class="social-link">
            <a href="https://www.facebook.com/profile.php?id=100054413443726"><img class="social-facebook" src="images/social-facebook.png" alt="fanpage"></a>
            <a href="#"><img class="socical-instagram" src="images/socical-instagram.png" alt=""></a>
            <a href="https://www.youtube.com/c/TrựcTiếpGameVN"><img class="social-youtube" src="images/social-youtube.png" alt=""></a>
        </div>
